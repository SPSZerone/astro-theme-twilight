enum I18nKey {
    ...
    skillsMusicInstrument = "skillsMusicInstrument",
    skillsMusicTool = "skillsMusicTool",
    skillsLanguage = "skillsLanguage",
    skillsOsPlatform = "skillsOsPlatform",
    skillsCloud = "skillsCloud",
    skillsGameEngine = "skillsGameEngine",
    skillsGraphicsPhysics = "skillsGraphicsPhysics",
    skillsGraphics = "skillsGraphics",
    skillsPhysics = "skillsPhysics",
    skillsGUI = "skillsGUI",
    skillsDocDiagram = "skillsDocDiagram",
    skillsDoc = "skillsDoc",
    skillsDiagram = "skillsDiagram",
    skillsSSG = "skillsSSG",
    skillsTerminal = "skillsTerminal",
    skillsShell = "skillsShell",
    skillsEditorIDE = "skillsEditorIDE",
    skillsMisc = "skillsMisc",
    skillsGameFullStack = "skillsGameFullStack",
    skillsGameServer = "skillsGameServer",
    skillsGameClient = "skillsGameClient",
    skillsAI = "skillsAI",
    ...
    timelinePiano = "timelinePiano",
    timelineViolin = "timelineViolin",
    timelineCello = "timelineCello",
    timelineCycling = "timelineCycling",
    timelineFitness = "timelineFitness",
    ...
    timelinePianoS = "timelinePianoS",
    timelineViolinS = "timelineViolinS",
    timelineCelloS = "timelineCelloS",
    timelineCyclingS = "timelineCyclingS",
    timelineFitnessS = "timelineFitnessS",
