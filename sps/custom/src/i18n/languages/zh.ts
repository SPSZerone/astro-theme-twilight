...
import type { Translation } from "@soscustom/i18n/translation";
...
export const zh: Translation = {
    ...
    [Key.skillsMusicInstrument]: "乐器",
    [Key.skillsMusicTool]: "音乐工具",
    [Key.skillsLanguage]: "编程语言",
    [Key.skillsOsPlatform]: "操作系统与平台",
    [Key.skillsCloud]: "云服务",
    [Key.skillsGameEngine]: "游戏引擎",
    [Key.skillsGraphicsPhysics]: "图形与物理",
    [Key.skillsGraphics]: "图形",
    [Key.skillsPhysics]: "物理",
    [Key.skillsGUI]: "GUI",
    [Key.skillsDocDiagram]: "文档 & 图表",
    [Key.skillsDoc]: "文档",
    [Key.skillsDiagram]: "图表",
    [Key.skillsSSG]: "静态网站生成",
    [Key.skillsTerminal]: "终端",
    [Key.skillsShell]: "Shell",
    [Key.skillsEditorIDE]: "编辑器 与 IDEs",
    [Key.skillsMisc]: "杂项",
    [Key.skillsGameFullStack]: "游戏全栈",
    [Key.skillsGameServer]: "游戏后端",
    [Key.skillsGameClient]: "游戏前端",
    [Key.skillsAI]: "AI 开发",
    ...
    [Key.timelinePiano]: "钢琴",
    [Key.timelineViolin]: "小提琴",
    [Key.timelineCello]: "大提琴",
    [Key.timelineCycling]: "骑行",
    [Key.timelineFitness]: "健身",
    ...
    [Key.timelinePianoS]: "钢琴数",
    [Key.timelineViolinS]: "小提琴数",
    [Key.timelineCelloS]: "大提琴数",
    [Key.timelineCyclingS]: "骑行数",
    [Key.timelineFitnessS]: "健身数",
