                ...
                <div class="section-header">
                    <div class="dropdown-wrapper">
                        ...
                        <div class="dropdown-menu-custom">
                            <button class="tiks-success tiks-hover dropdown-item-custom" class:active={timeScale === 'year'} onclick={() => timeScale = 'year'}>{labels.year}</button>
                            <button class="tiks-success tiks-hover dropdown-item-custom" class:active={timeScale === 'month'} onclick={() => timeScale = 'month'}>{labels.month}</button>
                            <button class="tiks-success tiks-hover dropdown-item-custom" class:active={timeScale === 'day'} onclick={() => timeScale = 'day'}>{labels.day}</button>
                        </div>
                    </div>
                </div>
